...
DATA_PATH = '/Users/craig/myprojects/data'
# MODELS_PATH = os.path.join(CAR_PATH, 'models')
PARTS_PATH = os.path.join(CAR_PATH, 'parts-one.yml')

################ Part PARAMETERS
# AI 
MODEL_PATH = 'models/M910.h5'

# tub_v2 
DATATUB_INPUTS = ['cam/image_array','user/angle', 'user/throttle', 'user/mode']
DATATUB_TYPES =  ['image_array', 'float', 'float', 'str']
DATATUB_METADATA = []
...
JOYSTICK_THROTTLE_SCALE = 1.0       #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
JOYSTICK_STEERING_SCALE = 1.0       #some people want a steering that is less sensitve. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
AUTO_RECORD_ON_THROTTLE = False     #if true, we will record whenever throttle is not zero. if false, you must manually toggle recording with some other trigger. Usually circle button on joystick.
JOYSTICK_DEADZONE = 0.0             # when non zero, this is the smallest throttle before recording triggered.
USE_FPV = False                     # send camera data to FPV webserver
# 
THROTTLE_OFFSET = 0.0               # 0.2
...
GYM_CONF = { "body_style" : "car01", "body_rgb" : (64, 128, 256), "car_name" : "RoadFox", "font_size" : 25} # body style(donkey|bare|car01) body rgb 0-255
GYM_CONF["racer_name"] = "Craig"
GYM_CONF["bio"] = "Retired Engineer"
SIM_HOST = "127.0.0.1"              # when racing on virtual-race-league use host "trainmydonkey.com"
# SIM_HOST = "DarkMatter.local"     # when racing on virtual-race-league use host "trainmydonkey.com"
SIM_ARTIFICIAL_LATENCY = 0          # When local
# SIM_ARTIFICIAL_LATENCY = 90       # When simulating roboticist.dev
...
#DONKEY_GYM_ENV_NAME = "donkey-thunderhill-track-v0"
#DONKEY_GYM_ENV_NAME = "donkey-circuit-launch-track-v0"
    

############################ AI CONFIGURATION
# #When racing, to give the ai a boost, configure these values.
AI_LAUNCH_DURATION = 2.0            # When starting in local mode set throttle for this many seconds
AI_LAUNCH_THROTTLE = 1.0            # When starting in local mode set throttle value
...
# AI_THROTTLE_MIN = 0.0               # increase the throttle to at least the miniumum value.
# 
# 
