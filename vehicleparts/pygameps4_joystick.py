...
from donkeycar.vehicleparts.jscontroller import PyGameJoystick, JoystickController
...
class PyGamePS4JoystickController(JoystickController):
    ...
    def __init__(self, cfg):
        ...
        self.outputs = ['user/angle', 'user/throttle', 'user/mode', 'recording', 'AImultiplier','command']
        self.threaded = True
...
#             'square' : None,
            ...
            'L2'          : self.increase_ai_throttle_multiplier,
            'Left_stick'  : self.increase_ai_throttle_multiplier,
            
            'R2'          : self.decrease_ai_throttle_multiplier,
            'Right_stick' : self.decrease_ai_throttle_multiplier,
