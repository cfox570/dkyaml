...
#         self.moving = False if self.moving else True
    ...
    def find_person(self): #fox
        '''
        command to reset the find_person algorithm
        '''
        self.joy_command = 5
        
#     def log_waypoint(self): #fox
#         '''
#         command to print out the current gps point
#         '''
#         self.joy_command = 4
# 
#     def prev_point(self): #fox
#         '''
#         command to select the previous gps waypoint
#         '''
#         self.joy_command = 2
#         print ('Select previous gps waypoint')
#  
#     def next_point(self): #fox
#         '''
#         command to select the next gps waypoint
#         '''
#         self.joy_command = 3
#         print ('Select next gps waypoint')
...
#         self.ai_throttle_multiplier = round((self.ai_throttle_multiplier + 0.2), 2)
        ...
        print ('AI_throttle_multiplier+:', self.ai_throttle_multiplier)
